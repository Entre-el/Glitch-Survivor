...
public class CharacterBaseStatsSO : ScriptableObject
{
    ...
    {
        get => playerCritChance;
        private set => playerCritChance = value;
    }
    ...
    {
        get => playerCritMultiplier;
        private set => playerCritMultiplier = value;
    }
    ...
    {
        get => playerPierce;
        private set => playerPierce = value;
    }
    ...
    {
        get => playerMagnetRadius;
        private set => playerMagnetRadius = value;
    }
    ...
    {
        get => playerProjectileSpeedMultiplier;
        private set => playerProjectileSpeedMultiplier = value;
    }

    [SerializeField]
    private float playerRecoveryPre5s = 0f;
    public float PlayerRecoveryPre5s
    {
        get => playerRecoveryPre5s;
        private set => playerRecoveryPre5s = value;
    }
    ...
    {
        get => playerMaxHealth;
        private set => playerMaxHealth = value;
    }
    ...
    {
        get => playerDashSpeed;
        private set => playerDashSpeed = value;
    }
    ...
    {
        get => playerDashCooldown;
        private set => playerDashCooldown = value;
    }
}
