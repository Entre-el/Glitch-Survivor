...
public class WeaponSO : WeaponOrItemSO
{
    ...
    public new string Description { get => description; private set => description = value; }
    [SerializeField] Sprite icon;
    public new Sprite Icon { get => icon; private set => icon = value; }
    private WeaponOrItemType type = WeaponOrItemType.Weapon;
    public new WeaponOrItemType Type { get => type; private set => type = value; }
}
