...
public class WeaponSlotUI : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler
{
    ...
    {
        if (highlightImage != null) highlightImage.enabled = isOn;
    }
    ...
    public void UpdateVisual(StickerSO sticker)
    {
        ...
        if (sticker != null)
        {
            ...
            if (backgroundImage != null) backgroundImage.color = new Color(1f, 1f, 1f, 0.3f); 
        }
        else
        {
            equippedIcon.sprite = null;
            equippedIcon.enabled = false;
            if (backgroundImage != null) backgroundImage.color = new Color(1f, 1f, 1f, 1f); 
        }
    }
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        if (currentSticker != null)
        {
            ...
            if (panel != null && panel.gameObject.activeInHierarchy)
            {
                ...
                panel.SpawnStickerAtMouse(stickerToDrop, eventData.position, eventData.pressEventCamera);
            }
        }
    }
